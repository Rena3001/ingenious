(function ($) {
    ...
    if ($(".mobile-menu").length) {
        ...
        $(".mobile-header .nav-outer").append(
    ...
    if ($(".cooked-single-ingredient").length) {
        $(".cooked-single-ingredient .cooked-ingredient-checkbox").on(
            "click",
            function () {
                $(this)
                    .parent(".cooked-single-ingredient")
                    .toggleClass("checked");
            },
        );
    }
                ...
                beforeSend: function () {
                    $("#email-form .response").html(
                        '<div class="text-info"><img src="' +
                            "{{ asset('assets/images/icons/preloader.gif') }}" +
                            '"> ' +
    ...
    var fast = 200;
    $(".dir-hover .portfolio-block").hover(
        function (e) {
