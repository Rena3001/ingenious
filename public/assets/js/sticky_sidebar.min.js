...
!(function (i) {
    i.fn.theiaStickySidebar = function (t) {
        function o(t, o) {
            return (
                !0 === t.initialized ||
                (!(i("body").width() < t.minWidth) && (e(t, o), !0))
            );
        }
        function e(t, o) {
            (t.initialized = !0),
                    ...
                    a.stickySidebar.css("padding-top", 1),
                        ...
                        (a.onScroll = function (a) {
                            if (a.stickySidebar.is(":visible"))
                                if (i("body").width() < a.options.minWidth) o();
                                else if (
                                    ...
                                    if ("fixed" == d)
                                        ...
                                        "absolute" !=
                                            ...
                                            (m.width = a.sidebar.width()),
                                            (m.left = ""),
                                            a.stickySidebar.css(m);
                                    } else "static" == d && o();
                                    "static" != d &&
        ...
        ((t = i.extend(a, t)).additionalMarginTop =
