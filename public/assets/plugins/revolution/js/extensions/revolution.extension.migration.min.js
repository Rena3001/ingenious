    ...
    jQuery.extend(!0, b, {
        hideUnHideNav: function (a) {
            ...
            m(c) && y(a.c.find(".tparrows"), c.hide_under, b, c.hide_over),
                m(d) &&
                    y(a.c.find(".tp-bullets"), d.hide_under, b, d.hide_over),
                m(e) &&
                    y(
                        a.c.parent().find(".tp-thumbs"),
                        e.hide_under,
                        b,
                        e.hide_over
                    ),
                ...
                if (
                    ...
                    i.find(".tp-bullet").each(function (a) {
                        var b = jQuery(this),
                            ...
                            d =
                                b.outerWidth() +
                                parseInt(void 0 === h.space ? 0 : h.space, 0),
                            e =
                                b.outerHeight() +
                                parseInt(void 0 === h.space ? 0 : h.space, 0);
        ...
        manageNavigation: function (a) {
            ...
            m(a.navigation.bullets) &&
                ...
                m(a.navigation.arrows) &&
                    ...
                    t(
                        a.c.find(".tp-leftarrow.tparrows"),
                        a.navigation.arrows.left,
                        a
                    ),
                    t(
                        a.c.find(".tp-rightarrow.tparrows"),
                        a.navigation.arrows.right,
                        a
                    )),
                m(a.navigation.thumbnails) &&
            ...
            h(a, f),
                            ...
                            jQuery.each(f.thumbs[i].params, function (a, b) {
                                ...
                                j.rtl
                                    ? (punchgs.TweenLite.set(
                                          j.left.j.find(".tp-arr-imgholder"),
                                          {
                                              backgroundImage:
                                                  "url(" +
                                                  f.thumbs[i].src +
                                      ...
                                      punchgs.TweenLite.set(
                                          j.right.j.find(".tp-arr-imgholder"),
                                          {
                                              backgroundImage:
                                                  "url(" +
                                                  f.thumbs[h].src +
                ...
                g.on("mouseenter mousemove", function () {
                    g.hasClass("tp-mouseover") ||
                        ...
                        t &&
                            j.hide_onleave &&
                            p(g.find(".tparrows"), j, "show"),
                        v &&
                            n.hide_onleave &&
                            p(g.find(".tp-bullets"), n, "show"),
                        x &&
                            r.hide_onleave &&
                            p(g.find(".tp-thumbs"), r, "show"),
    ...
    var e = function (a, b) {
        ...
        f = function (a, b, c, d, e, f) {
            var g = c.parent().find(".tp-" + f + "s"),
                ...
                i = g.find(".tp-" + f + "-mask"),
                j =
                    d.width * a < d.min_width
                        ? d.min_width
                        : Math.round(d.width * a),
            ...
            if (
                ...
                a.on("mousewheel DOMMouseScroll", function (f) {
                    var h = g(f.originalEvent),
                        i = a
                            .find(".tp-revslider-slidesli.active-revslide")
                            .index(),
                        j = a
                            .find(".tp-revslider-slidesli.processing-revslide")
                            .index(),
                        k = (-1 != i && 0 == i) || (-1 != j && 0 == j),
                        l =
                        ...
                        -1 == j
                            ? h.pixelY < d
                                ? (k ||
                                      ((c.sc_indicator = "arrow"),
                                      "reverse" !==
                                          c.navigation.mouseScrollReverse &&
                                          ((c.sc_indicator_dir = 1),
                                          b.callingNewSlide(a, -1)),
                                      (m = !1)),
                                  l ||
                    ...
                    swipeStatus: function (e, g, h, i, l, m, n) {
                        ...
                        if (
                            ...
                            var z = a.parent().find(v),
                                ...
                                E =
                                    "vertical" === B
                                        ? z.find(x).first().outerHeight(!0) +
                                          y.space
                                        : z.find(x).first().outerWidth(!0) +
                                          y.space,
                                F =
        ...
        q = function (a, b, c) {
            ...
            b.rtl
                ...
                (b.padding_bottom = parseInt(
                    c.carousel.padding_bottom || 0,
                    0
                )),
                t(d, b.left, c),
                t(e, b.right, c),
                ...
                g =
                    "layergrid" == b.container
                        ? "fullscreen" == c.sliderLayout
                            ? c.height / 2 -
                              (c.gridheight[c.curWinRange] * c.bh) / 2
                            : "on" == c.autoHeight ||
                ...
                f =
                    "layergrid" == b.container
                        ? "carousel" === c.sliderType
                            ? 0
                            : c.width / 2 -
                              (c.gridwidth[c.curWinRange] * c.bw) / 2
                        : 0,
                g =
                    "left" === b.h_align
        ...
        u = function (a, b, c, d) {
            ...
            jQuery.each(d.thumbs[c.index()].params, function (a, b) {
                ...
                e.append(
                    '<div class="justaddedbullet tp-bullet">' + g + "</div>"
                );
            var h = a.find(".justaddedbullet"),
                i = a.find(".tp-bullet").length,
                j =
                    h.outerWidth() +
                    parseInt(void 0 === b.space ? 0 : b.space, 0),
                k =
                    h.outerHeight() +
                    parseInt(void 0 === b.space ? 0 : b.space, 0);
        ...
        w = function (a, b, c, d, e) {
            ...
            var m = c.data("index"),
                ...
                q =
                    "horizontal" === b.direction
                        ? b.width * b.visibleAmount +
                          b.space * (b.visibleAmount - 1)
                        : b.width,
                r =
                    "horizontal" === b.direction
                        ? b.height
                        : b.height * b.visibleAmount +
                          b.space * (b.visibleAmount - 1),
                s = b.tmp;
