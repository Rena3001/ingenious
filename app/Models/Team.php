...
class Team extends Model
{
    ...
    protected $fillable = [
        'name_az','name_en','name_ru','name_de','name_es','name_fr','name_zh',
        'position_az','position_en','position_ru','position_de','position_es','position_fr','position_zh',
        'desc_az','desc_en','desc_ru','desc_de','desc_es','desc_fr','desc_zh',
        'image',
        'twitter',
        'facebook',
        'linkedin',
